...
- **copy-trader-exits** — Runs the exit monitor (`run_exits.py --mode live`) every 60s during market hours: reconcile, reprice a resting stop-loss, cancel stale entries, stop-loss and fixed take-profit ladder. Refuses locally when disarmed or halted.
